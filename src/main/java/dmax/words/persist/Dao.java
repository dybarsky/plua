...
public abstract class Dao<T extends Persistable> implements Constants {
    ...
    /**
     * Reset persistable data set by methods {@link #setPersistable(dmax.words.domain.Persistable)}
    ...
    /**
     * Get it set by by methods {@link #setPersistable(dmax.words.domain.Persistable)}
    ...
    /**
     * Inserts into database new record based on data set by method {@link #setPersistable(dmax.words.domain.Persistable)}
     * @return inserted entity with correct id.
     */
    public abstract T insert(SQLiteDatabase db);

    /**
     * Load from database entity using id set by method {@link #setPersistable(dmax.words.domain.Persistable)}
     * or {@link #setRetrieveId(long)}
    ...
    /**
     * Removed from database record with id set by method {@link #setPersistable(dmax.words.domain.Persistable)}
     * or {@link #setRetrieveId(long)}
    ...
    /**
     * Updates in database record based on data set by method {@link #setPersistable(dmax.words.domain.Persistable)}
